    ...
    return (
        <div className="bg-white rounded-xl overflow-hidden relative text-gray-600 w-full shadow-[0px_5px_10px_rgba(0,0,0,0.08)] ">
            <Link to={`/room/${room._id}`}>
                <img className="w-full h-52 sm:h-64 md:h-52 object-cover" src={room.images[0]} alt="hotel-img" />
                <div className="p-5">
                    <div>
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <Button classes="border-2 border-gray-200 rounded py-2 px-4 cursor-pointer hover:bg-gray-100">Book Now</Button>
                    </div>
                </div>
            </Link>
        </div>
